...
; Keywords
[
  "and" "in" "is" "not" "or" "is not" "not in" "del"
] @keyword.operator
...
[
  "assert" "exec" "global" "nonlocal" "pass" "print" "with" "as"
] @keyword
...
(future_import_statement "from" @keyword.import "__future__" @module.builtin)
...
[
  "try" "except" "except*" "raise" "finally"
] @keyword.exception
