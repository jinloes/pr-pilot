...
(method_elem name: (field_identifier) @function.method)
...
; Keywords
[
  "break" "const" "continue" "default" "defer" "goto" "range" "select" "var" "fallthrough"
] @keyword
...
(keyed_element . (literal_element (identifier) @variable.member))
