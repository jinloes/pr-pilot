...
(class_parameter (simple_identifier) @variable.member)

(_
  (navigation_suffix (simple_identifier) @variable.member))
...
(type_alias (type_identifier) @type.definition)
...
(file_annotation (user_type (type_identifier) @attribute))
...
[
  (class_modifier) (member_modifier) (function_modifier) (property_modifier)
  (platform_modifier) (variance_modifier) (parameter_modifier) (visibility_modifier)
  (reification_modifier) (inheritance_modifier)
] @keyword.modifier
...
[
  "for" "do" "while" "continue" "continue@" "break" "break@"
] @keyword.repeat
